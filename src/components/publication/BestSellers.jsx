            ...
            {bestseller.length === 0 ? (
                <div className="text-center py-12">
                    <div className="w-24 h-24 mx-auto mb-6 bg-gray-200 rounded-full flex items-center justify-center">
                        <i className="bi bi-trophy text-4xl text-gray-400"></i>
                    </div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">No hay productos más vendidos</h3>
                    <p className="text-gray-600">Pronto tendremos estadísticas de ventas para mostrar</p>
                </div>
            ) : (
