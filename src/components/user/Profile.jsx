            ...
            <form role="form text-left" onSubmit={updateUser}>
              <div className="mb-3 d-flex justify-content-center position-relative">
                <div className="avatar-container">
                  <input type="file" id="file0" name='file0' className="avatar-input" accept="image/*" style={{ display: 'none' }}></input>
                  <label htmlFor="file0" className="file0-label">
                    <div className='change-avatar-btn'>
                      <i className="bi bi-camera"></i>
                    </div>
                  </label>
                  {auth.image === 'default.png' ? (
                    <img src={avatar} className="avatar" alt="Foto de perfil"></img>
                  ) : (
                    <img src={Global.url + "user/avatar/" + auth.image} className="avatar" alt="Foto de perfil"></img>
                  )}
                </div>
              </div>
              <div className="mb-3">
